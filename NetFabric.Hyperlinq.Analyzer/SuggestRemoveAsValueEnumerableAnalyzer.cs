    ...
    public class SuggestRemoveAsValueEnumerableAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static bool IsChainingNeeded(InvocationExpressionSyntax invocation)
        {
            ...
            if (IsLinqMethod(methodName))
            {
                ...
                var parentInvocation = parentMemberAccess.Parent as InvocationExpressionSyntax;
        ...
        {
            return methodName is "Where" or "Select" or "Any" or "Count" or "First" or "Single" or "Sum" or 
