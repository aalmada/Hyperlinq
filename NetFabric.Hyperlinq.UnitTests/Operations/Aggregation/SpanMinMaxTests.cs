...
public class SpanMinMaxTests
{
    ...
    public void Array_Min_WithPredicate_ShouldMatchLinq(TestCase<int[]> testCase)
    {
        ...
        {
            _ = Assert.Throws<InvalidOperationException>(() => array.Min(predicate));
        }
    }
    ...
    public void Array_Max_WithPredicate_ShouldMatchLinq(TestCase<int[]> testCase)
    {
        ...
        {
            _ = Assert.Throws<InvalidOperationException>(() => array.Max(predicate));
        }
    }
    ...
    public void List_Min_WithPredicate_NoMatch_ShouldThrow()
    {
        ...
        _ = Assert.Throws<InvalidOperationException>(() => list.Min(x => x > 0));
    }
    ...
    public void Array_Max_WithPredicate_NoMatch_ShouldThrow()
    {
        ...
        _ = Assert.Throws<InvalidOperationException>(() => array.Max(x => x > 0));
    }
    ...
    public void ArraySegment_Min_WithPredicate_NoMatch_ShouldThrow()
    {
        ...
        _ = Assert.Throws<InvalidOperationException>(() => segment.Min(x => x > 0));
    }
    ...
    public void ArraySegment_Max_WithPredicate_NoMatch_ShouldThrow()
    {
        ...
        _ = Assert.Throws<InvalidOperationException>(() => segment.Max(x => x > 0));
    }
    ...
    public void Array_MinMax_ShouldWork()
    {
        ...
        _ = result.Min.Must().BeEqualTo(1);
        _ = result.Max.Must().BeEqualTo(9);
    }
    ...
    public void List_MinMax_ShouldWork()
    {
        ...
        _ = result.Max.Must().BeEqualTo(30);
    }
    ...
    public void ReadOnlySpan_MinMax_ShouldWork()
    {
        ...
        _ = result.Min.Must().BeEqualTo(3);
        _ = result.Max.Must().BeEqualTo(22);
    }
    ...
    public void Double_MinMax_ShouldWork()
    {
        ...
        _ = result.Min.Must().BeEqualTo(0.5);
        _ = result.Max.Must().BeEqualTo(3.7);
    }
    ...
    public void List_MinMax_WithPredicate_ShouldWork()
    {
        ...
        _ = result.Min.Must().BeEqualTo(20);
        _ = result.Max.Must().BeEqualTo(30);
    }
    ...
    public void Array_MinMax_Empty_ShouldThrow()
    {
        ...
        _ = Assert.Throws<InvalidOperationException>(() => array.MinMax());
    }
    ...
    public void Array_MinMax_WithPredicate_NoMatch_ShouldThrow()
    {
        ...
        _ = Assert.Throws<InvalidOperationException>(() => array.MinMax(x => x % 2 == 0));
    }
    ...
    public void Array_MinMax_SingleElement_ShouldReturnSame()
    {
        ...
        _ = result.Min.Must().BeEqualTo(42);
        _ = result.Max.Must().BeEqualTo(42);
    }
}
