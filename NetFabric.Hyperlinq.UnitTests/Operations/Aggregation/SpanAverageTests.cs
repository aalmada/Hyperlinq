...
public class SpanAverageTests
{
    ...
    public void ReadOnlySpan_Average_ShouldWork()
    {
        ...
        _ = result.Must().BeEqualTo(5); // (5+2+8+1+9)/5 = 25/5 = 5
    }
    ...
    public void Span_Average_ShouldWork()
    {
        ...
        _ = result.Must().BeEqualTo(20); // (10+20+30)/3 = 60/3 = 20
    }
    ...
    public void Double_Average_ShouldWork()
    {
        ...
        _ = result.Must().BeEqualTo(3.0); // (1.5+2.5+3.5+4.5)/4 = 12/4 = 3.0
    }
    ...
    public void Long_Average_ShouldWork()
    {
        ...
        _ = result.Must().BeEqualTo(12L); // (5+10+15+20)/4 = 50/4 = 12 (integer division)
    }
    ...
    public void Array_Average_WithPredicate_ShouldWork(TestCase<int[]> testCase)
    {
        ...
        {
            _ = Assert.Throws<InvalidOperationException>(() => array.Average(predicate));
        }
    }
    ...
    public void ReadOnlySpan_Average_WithPredicate_ShouldWork()
    {
        ...
        _ = result.Must().BeEqualTo(4); // (2+4+6)/3 = 12/3 = 4
    }
    ...
    public void List_Average_WithPredicate_ShouldWork()
    {
        ...
        _ = result.Must().BeEqualTo(40); // (30+40+50)/3 = 120/3 = 40
    }
    ...
    public void Array_Average_Empty_ShouldThrow()
    {
        ...
        _ = Assert.Throws<InvalidOperationException>(() => array.Average());
    }
    ...
    public void ReadOnlyMemory_Average_Empty_ShouldThrow()
    {
        ...
        _ = Assert.Throws<InvalidOperationException>(() => memory.Average());
    }
    ...
    public void List_Average_WithPredicate_NoMatch_ShouldThrow()
    {
        ...
        _ = Assert.Throws<InvalidOperationException>(() => list.Average(x => x > 0));
    }
    ...
    public void Array_Average_WithPredicate_NoMatch_ShouldThrow()
    {
        ...
        _ = Assert.Throws<InvalidOperationException>(() => array.Average(x => x > 0));
    }
    ...
    public void ArraySegment_Average_WithOffset_ShouldWork()
    {
        ...
        _ = result.Must().BeEqualTo(25); // (10+20+30+40)/4 = 100/4 = 25
    }
    ...
    public void ReadOnlyMemory_Average_WithPredicate_ShouldWork()
    {
        ...
        _ = result.Must().BeEqualTo(3); // (1+3+5)/3 = 9/3 = 3
    }
    ...
    public void List_AverageOrNone_WithData_ShouldReturnSome()
    {
        ...
        _ = result.Value.Must().BeEqualTo(20); // (10+20+30)/3 = 20
    }
    ...
    public void ReadOnlySpan_AverageOrNone_WithPredicate_ShouldReturnSome()
    {
        ...
        _ = result.HasValue.Must().BeTrue();
        _ = result.Value.Must().BeEqualTo(4); // (2+4+6)/3 = 4
    }
    ...
    public void Double_AverageOrNone_ShouldWork()
    {
        ...
        _ = result.HasValue.Must().BeTrue();
        _ = result.Value.Must().BeEqualTo(4.0); // (2+4+6)/3 = 4.0
    }
}
