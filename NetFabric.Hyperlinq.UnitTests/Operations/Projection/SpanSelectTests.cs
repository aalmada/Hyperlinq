...
public class SpanSelectTests
{
    ...
    public void Array_Select_ShouldMatchLinq(TestCase<int[]> testCase)
    {
        ...
        _ = hyperlinqResult.ToArray().Must()
            .BeEnumerableOf<int>()
    ...
    public void Array_Select_Count_ShouldMatchLinq(TestCase<int[]> testCase)
    {
        ...
        _ = result.Count().Must().BeEqualTo(array.Length);
    }
    ...
    public void List_Select_Count_ShouldMatchLinq(TestCase<int[]> testCase)
    {
        ...
        _ = result.Count().Must().BeEqualTo(list.Count);
    }
    ...
    public void Array_Select_ComplexProjection_ShouldMatchLinq()
    {
        ...
        _ = hyperlinqResult.Count().Must().BeEqualTo(linqResult.Count());
