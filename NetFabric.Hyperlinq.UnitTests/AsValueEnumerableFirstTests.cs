...
public class AsValueEnumerableFirstTests
{
    ...
    public void IEnumerable_AsValueEnumerable_First_ShouldMatchLinq((Func<IEnumerable<int>> enumerableFactory, string description) testCase)
    {
    ...
    public void ICollection_AsValueEnumerable_First_ShouldMatchLinq((Func<ICollection<int>> collectionFactory, string description) testCase)
    {
