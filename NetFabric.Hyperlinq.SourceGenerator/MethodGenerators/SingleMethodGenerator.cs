...
{
    class SingleMethodGenerator : IMethodGenerator
    {
        public string MethodName => "Single";
        ...
        public InvocationInfo? TryGetInvocation(GeneratorSyntaxContext context, MemberAccessExpressionSyntax memberAccess, IMethodSymbol methodSymbol)
        {
            ...
            return new InvocationInfo(context.Node as InvocationExpressionSyntax, methodSymbol, "Single", methodSymbol.ContainingType.ToDisplayString(), false);
        }
